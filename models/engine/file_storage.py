#!/usr/bin/python3
"""
Serializes objects/instances to a JSON file and
...
class FileStorage:
    """The file storage engine class, which is a class that 
    ...
    def new(self, obj):
        """Setting new obj in __objects dictionary."""
    ...
    def reload(self):
        """Deserializing the JSON file to __objects if it exists"""
